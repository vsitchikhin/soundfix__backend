"""
Django settings for soundfix__backend project.
...
SECRET_KEY = 'django-insecure-pkgs+n3!aga_1^s0x*(kcx^k_o17)0b-b2qr6tbwh9&=(8c97a'
...
WSGI_APPLICATION = 'soundfix__backend.wsgi.application'
